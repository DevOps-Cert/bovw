...
object Extractor {
  ...
  def matchFeatures(scale : Integer){
    ...
    // match two images
    pointMatch(image0, mat0, points0(marks0(scale - 1) + 1), image1, mat1, points1(marks1(scale - 1) + 1), scale)
  }
  ...
  def pointMatch(image0 : IplImage, mat0 : CvMat, point0 : KeyPoint, image1 : IplImage, mat1 : CvMat, point1 : KeyPoint, scale:Integer){
    ...
    save(new File("resources/match" + scale + ".jpg"), imageMatches)
